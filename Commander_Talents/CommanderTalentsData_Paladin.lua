-- Commander_Talents — PALADIN talent data (GENERATED 2026-08-04).
...
CommanderTalentsData.Classes.PALADIN = {
    trees = {
        {
            name = "Holy", bg = "PaladinHoly",
            talents = {
                { name = "Divine Strength", icon = "ability_golemthunderclap", row = 1, col = 2, max = 5,
                  ranks = {
                ...
                { name = "Divine Intellect", icon = "spell_nature_sleep", row = 1, col = 3, max = 5,
                  ranks = {
                ...
                { name = "Spiritual Focus", icon = "spell_arcane_blink", row = 2, col = 2, max = 5,
                  ranks = {
                    "Gives you a 14% chance to avoid interruption caused by damage while casting Flash of Light and Holy Light.",
                    "Gives you a 28% chance to avoid interruption caused by damage while casting Flash of Light and Holy Light.",
                    "Gives you a 42% chance to avoid interruption caused by damage while casting Flash of Light and Holy Light.",
                    "Gives you a 56% chance to avoid interruption caused by damage while casting Flash of Light and Holy Light.",
                    "Gives you a 70% chance to avoid interruption caused by damage while casting Flash of Light and Holy Light.",
                  } },
                { name = "Improved Seal of Righteousness", icon = "ability_thunderbolt", row = 2, col = 3, max = 5,
                  ranks = {
                ...
                { name = "Healing Light", icon = "spell_holy_holybolt", row = 3, col = 1, max = 3,
                  ranks = {
                ...
                { name = "Improved Lay on Hands", icon = "spell_holy_layonhands", row = 3, col = 2, max = 2,
                  ranks = {
                ...
                { name = "Unyielding Faith", icon = "spell_holy_unyieldingfaith", row = 3, col = 3, max = 2,
                  ranks = {
                ...
                { name = "Illumination", icon = "spell_holy_greaterheal", row = 4, col = 2, max = 5,
                  ranks = {
                    ...
                    "After getting a critical effect from your Flash of Light, Holy Light, or Holy Shock heal spell, gives you an 80% chance to gain mana equal to 60% of the base cost of the spell.",
                ...
                { name = "Improved Blessing of Wisdom", icon = "spell_holy_sealofwisdom", row = 4, col = 3, max = 2,
                  ranks = {
                    "Increases the effect of your Blessing of Wisdom spell by 10%.",
                    "Increases the effect of your Blessing of Wisdom spell by 20%.",
                  } },
                { name = "Pure of Heart", icon = "spell_holy_pureofheart", row = 5, col = 1, max = 3,
                  ranks = {
                    "Increases your resistance to Curse and Disease effects by an additional 5%.",
                    "Increases your resistance to Curse and Disease effects by an additional 10%.",
                    "Increases your resistance to Curse and Disease effects by an additional 15%.",
                  } },
                { name = "Divine Favor", icon = "spell_holy_heal", row = 5, col = 2, max = 1,
                  ranks = {
                    "When activated, gives your next Flash of Light, Holy Light, or Holy Shock spell a 100% critical effect chance.",
                  } },
                { name = "Sanctified Light", icon = "spell_holy_healingaura", row = 5, col = 3, max = 3,
                  ranks = {
                ...
                { name = "Purifying Power", icon = "spell_holy_purifyingpower", row = 6, col = 2, max = 2,
                  ranks = {
                ...
                { name = "Holy Power", icon = "spell_holy_power", row = 6, col = 3, max = 5,
                  ranks = {
                ...
                { name = "Light's Grace", icon = "spell_holy_lightsgrace", row = 7, col = 1, max = 3,
                  ranks = {
                ...
                { name = "Holy Shock", icon = "spell_holy_searinglight", row = 7, col = 2, max = 1, req = "Divine Favor",
                  ranks = {
                    "Blasts the target with Holy energy, causing 277 to 299 Holy damage to an enemy, or 351 to 379 healing to an ally.",
                  } },
                { name = "Blessed Life", icon = "spell_holy_blessedlife", row = 7, col = 3, max = 3,
                  ranks = {
                ...
                { name = "Holy Guidance", icon = "spell_holy_holyguidance", row = 8, col = 2, max = 5,
                  ranks = {
                ...
                { name = "Divine Illumination", icon = "spell_holy_divineillumination", row = 9, col = 2, max = 1,
                  ranks = {
        ...
        {
            name = "Protection", bg = "PaladinProtection",
            talents = {
                { name = "Improved Devotion Aura", icon = "spell_holy_devotionaura", row = 1, col = 2, max = 5,
                  ranks = {
                ...
                { name = "Redoubt", icon = "ability_defend", row = 1, col = 3, max = 5,
                  ranks = {
                    "Increases your chance to block attacks with a shield by 6% after being the victim of a critical strike. Lasts 10 sec or 5 blocks.",
                    "Increases your chance to block attacks with a shield by 12% after being the victim of a critical strike. Lasts 10 sec or 5 blocks.",
                    "Increases your chance to block attacks with a shield by 18% after being the victim of a critical strike. Lasts 10 sec or 5 blocks.",
                    "Increases your chance to block attacks with a shield by 24% after being the victim of a critical strike. Lasts 10 sec or 5 blocks.",
                    "Increases your chance to block attacks with a shield by 30% after being the victim of a critical strike. Lasts 10 sec or 5 blocks.",
                  } },
                { name = "Precision", icon = "ability_marksmanship", row = 2, col = 1, max = 3,
                  ranks = {
                ...
                { name = "Guardian's Favor", icon = "spell_holy_sealofprotection", row = 2, col = 2, max = 2,
                  ranks = {
                ...
                { name = "Toughness", icon = "spell_holy_devotion", row = 2, col = 4, max = 5,
                  ranks = {
                ...
                { name = "Blessing of Kings", icon = "spell_magic_greaterblessingofkings", row = 3, col = 1, max = 1,
                  ranks = {
                    "Places a Blessing on the party member, increasing total stats by 10% for 10 min. Players may only have one Blessing on them per Paladin at any one time.",
                  } },
                { name = "Improved Righteous Fury", icon = "spell_holy_sealoffury", row = 3, col = 2, max = 3,
                  ranks = {
                    "While Righteous Fury is active, all damage taken is reduced by 2% and the threat generated by your Righteous Fury spell is increased by 16%.",
                    "While Righteous Fury is active, all damage taken is reduced by 4% and the threat generated by your Righteous Fury spell is increased by 33%.",
                    "While Righteous Fury is active, all damage taken is reduced by 6% and the threat generated by your Righteous Fury spell is increased by 50%.",
                  } },
                { name = "Shield Specialization", icon = "inv_shield_06", row = 3, col = 3, max = 3,
                  ranks = {
                ...
                { name = "Stoicism", icon = "spell_holy_stoicism", row = 4, col = 1, max = 2,
                  ranks = {
                ...
                { name = "Improved Hammer of Justice", icon = "spell_holy_sealofmight", row = 4, col = 2, max = 3,
                  ranks = {
                    ...
                    "Decreases the cooldown of your Hammer of Justice spell by 45 sec.",
                  } },
                { name = "Improved Concentration Aura", icon = "spell_holy_mindsooth", row = 4, col = 3, max = 3,
                  ranks = {
                    "Increases the effect of your Concentration Aura by an additional 5% and reduces the duration of any Silence or Interrupt effect used against an affected group member by 10%.",
                    "Increases the effect of your Concentration Aura by an additional 10% and reduces the duration of any Silence or Interrupt effect used against an affected group member by 20%.",
                    "Increases the effect of your Concentration Aura by an additional 15% and reduces the duration of any Silence or Interrupt effect used against an affected group member by 30%.",
                  } },
                { name = "Spell Warding", icon = "spell_holy_spellwarding", row = 5, col = 2, max = 2,
                  ranks = {
                    "All spell damage taken is reduced by 2%.",
                    "All spell damage taken is reduced by 4%.",
                  } },
                { name = "Blessing of Sanctuary", icon = "spell_nature_lightningshield", row = 5, col = 3, max = 1,
                  ranks = {
                    "Places a Blessing on the party member, reducing damage dealt from all sources by up to 10 for 10 min. In addition, when the target blocks a melee attack the attacker will take 14 Holy damage. Players may only have one Blessing on them per Paladin at any one time.",
                  } },
                { name = "Reckoning", icon = "spell_holy_blessingofstrength", row = 6, col = 1, max = 5,
                  ranks = {
                    ...
                    "Gives you an 8% chance after being hit by any damaging attack that the next 4 weapon swings within 8 sec will generate an additional attack.",
                ...
                { name = "Sacred Duty", icon = "spell_holy_divineintervention", row = 6, col = 2, max = 2,
                  ranks = {
                    "Increases your total Stamina by 3%, reduces the cooldown of your Divine Shield spell by 30 sec and reduces the attack speed penalty of your Divine Shield spell by 50%.",
                    "Increases your total Stamina by 6%, reduces the cooldown of your Divine Shield spell by 60 sec and removes the attack speed penalty of your Divine Shield spell.",
                  } },
                { name = "One-Handed Weapon Specialization", icon = "inv_sword_20", row = 6, col = 3, max = 5,
                  ranks = {
                    "Increases all damage you deal by 1% when a one-handed melee weapon is equipped.",
                    "Increases all damage you deal by 2% when a one-handed melee weapon is equipped.",
                    "Increases all damage you deal by 3% when a one-handed melee weapon is equipped.",
                    "Increases all damage you deal by 4% when a one-handed melee weapon is equipped.",
                    "Increases all damage you deal by 5% when a one-handed melee weapon is equipped.",
                  } },
                { name = "Improved Holy Shield", icon = "spell_holy_blessingofprotection", row = 7, col = 2, max = 2, req = "Holy Shield",
                  ranks = {
                ...
                { name = "Holy Shield", icon = "spell_holy_blessingofprotection", row = 7, col = 3, max = 1, req = "Blessing of Sanctuary",
                  ranks = {
                ...
                { name = "Ardent Defender", icon = "spell_holy_ardentdefender", row = 7, col = 4, max = 5,
                  ranks = {
                ...
                { name = "Combat Expertise", icon = "spell_holy_weaponmastery", row = 8, col = 3, max = 5,
                  ranks = {
                ...
                { name = "Avenger's Shield", icon = "spell_holy_avengersshield", row = 9, col = 2, max = 1,
                  ranks = {
        ...
        {
            name = "Retribution", bg = "PaladinCombat",
            talents = {
                { name = "Improved Blessing of Might", icon = "spell_holy_fistofjustice", row = 1, col = 2, max = 5,
                  ranks = {
                ...
                { name = "Benediction", icon = "spell_frost_windwalkon", row = 1, col = 3, max = 5,
                  ranks = {
                ...
                { name = "Improved Judgement", icon = "spell_holy_righteousfury", row = 2, col = 1, max = 2,
                  ranks = {
                    "Decreases the cooldown of your Judgement spell by 1 sec.",
                    "Decreases the cooldown of your Judgement spell by 2 sec.",
                  } },
                { name = "Improved Seal of the Crusader", icon = "spell_holy_holysmite", row = 2, col = 2, max = 3,
                  ranks = {
                ...
                { name = "Deflection", icon = "ability_parry", row = 2, col = 3, max = 5,
                  ranks = {
                ...
                { name = "Vindication", icon = "spell_holy_vindication", row = 3, col = 1, max = 3,
                  ranks = {
                    "Gives your damaging melee attacks a chance to reduce the target's attributes by 5% for 15 sec.",
                    "Gives your damaging melee attacks a chance to reduce the target's attributes by 10% for 15 sec.",
                    "Gives your damaging melee attacks a chance to reduce the target's attributes by 15% for 15 sec.",
                  } },
                { name = "Conviction", icon = "spell_holy_retributionaura", row = 3, col = 2, max = 5,
                  ranks = {
                ...
                { name = "Seal of Command", icon = "ability_warrior_innerrage", row = 3, col = 3, max = 1,
                  ranks = {
                    "Fills the Paladin with the spirit of command, giving each melee attack a chance to deal additional Holy damage equal to 70% of normal weapon damage. Unleashing this Seal's energy will judge an enemy, instantly causing 46 to 51 Holy damage, 92 to 102 if the target is stunned or incapacitated. Lasts 30 sec.",
                  } },
                { name = "Pursuit of Justice", icon = "spell_holy_persuitofjustice", row = 3, col = 4, max = 3,
                  ranks = {
                ...
                { name = "Eye for an Eye", icon = "spell_holy_eyeforaneye", row = 4, col = 1, max = 2,
                  ranks = {
                    "All spell criticals against you cause 15% of the damage taken to the caster as well. This damage does not exceed 50% of your total health.",
                    "All spell criticals against you cause 30% of the damage taken to the caster as well. This damage does not exceed 50% of your total health.",
                  } },
                { name = "Improved Retribution Aura", icon = "spell_holy_auraoflight", row = 4, col = 3, max = 2,
                  ranks = {
                    "Increases the damage done by your Retribution Aura by 25%.",
                    "Increases the damage done by your Retribution Aura by 50%.",
                  } },
                { name = "Crusade", icon = "spell_holy_crusade", row = 4, col = 4, max = 3,
                  ranks = {
                ...
                { name = "Two-Handed Weapon Specialization", icon = "inv_hammer_04", row = 5, col = 1, max = 3,
                  ranks = {
                ...
                { name = "Sanctity Aura", icon = "spell_holy_mindvision", row = 5, col = 3, max = 1,
                  ranks = {
                ...
                { name = "Improved Sanctity Aura", icon = "spell_holy_mindvision", row = 5, col = 4, max = 2, req = "Sanctity Aura",
                  ranks = {
                    "Your Sanctity Aura also increases all damage caused by targets affected by the aura by 1%.",
                    "Your Sanctity Aura also increases all damage caused by targets affected by the aura by 2%.",
                  } },
                { name = "Vengeance", icon = "ability_racial_avatar", row = 6, col = 2, max = 5,
                  ranks = {
                ...
                { name = "Sanctified Seals", icon = "spell_holy_sealofblood", row = 7, col = 1, max = 3,
                  ranks = {
                ...
                { name = "Repentance", icon = "spell_holy_prayerofhealing", row = 7, col = 2, max = 1,
                  ranks = {
                ...
                { name = "Divine Purpose", icon = "spell_holy_divinepurpose", row = 7, col = 3, max = 3,
                  ranks = {
                    "Reduces the chance you'll be hit by spells and ranged attacks by 1%.",
                    "Reduces the chance you'll be hit by spells and ranged attacks by 2%.",
                    "Reduces the chance you'll be hit by spells and ranged attacks by 3%.",
                  } },
                { name = "Fanaticism", icon = "spell_holy_fanaticism", row = 8, col = 2, max = 5,
                  ranks = {
                    "Increases the critical strike chance of all Judgements capable of a critical hit by 3% and reduces threat caused by all actions by 6% except when Righteous Fury is active.",
                    "Increases the critical strike chance of all Judgements capable of a critical hit by 6% and reduces threat caused by all actions by 12% except when Righteous Fury is active.",
                    "Increases the critical strike chance of all Judgements capable of a critical hit by 9% and reduces threat caused by all actions by 18% except when Righteous Fury is active.",
                    "Increases the critical strike chance of all Judgements capable of a critical hit by 12% and reduces threat caused by all actions by 24% except when Righteous Fury is active.",
                    "Increases the critical strike chance of all Judgements capable of a critical hit by 15% and reduces threat caused by all actions by 30% except when Righteous Fury is active.",
                  } },
                { name = "Crusader Strike", icon = "spell_holy_crusaderstrike", row = 9, col = 2, max = 1,
                  ranks = {
    ...
    builds = {
        { key = "HOLY", name = "Holy", role = "HEALER",
          ...
          notes = "Flash of Light is your bread and butter; ride Light's Grace for fast Holy Lights on tank damage and keep Divine Favor plus Holy Shock as the instant save. Divine Illumination is the mana cooldown, and the Protection points buy Blessing of Kings plus Improved Concentration Aura -- the Anticipation and Toughness filler ranks are freely movable." },
        { key = "PROTECTION", name = "Protection", role = "TANK",
          ...
          stats = {
            "Uncrushable: 102.4% combined avoidance",
            "Defense to 490 (crit immune)",
            "Stamina",
            "Spell damage (threat)",
            "Block value",
            "Armor",
          },
          notes = "Keep Holy Shield rolling to stay uncrushable and open with Avenger's Shield; Righteous Fury, Consecration and your judged seal carry threat while raid healing feeds you mana through Spiritual Attunement. Spell Warding or an Improved Righteous Fury rank can flex into Improved Hammer of Justice or Guardian's Favor for utility." },
        { key = "RETRIBUTION", name = "Retribution", role = "MELEE",
          points = {
            [1] = {
                ["Divine Strength"] = 5,
            },
          ...
          notes = "Run Seal of Blood (Horde) or twist Seal of Command (Alliance) with Crusader Strike and Judgement on cooldown, and keep Sanctity Aura plus judged Crusader up for the group. Repentance is the flex point -- Pursuit of Justice or Vindication are fine swaps on fights where the CC never lands." },
    },
}
