    ...
    trees = {
        {
            ...
            talents = {
                ...
                { name = "Aura Mastery", icon = "spell_holy_auramastery", row = 3, col = 2, max = 1,
                  ranks = {
                    "Increases the radius of your Auras to 40 yards.",
                  } },
                { name = "Improved Lay on Hands", icon = "spell_holy_layonhands", row = 3, col = 3, max = 2,
                  ranks = {
                ...
                { name = "Unyielding Faith", icon = "spell_holy_unyieldingfaith", row = 3, col = 4, max = 2,
                  ranks = {
                ...
                { name = "Divine Favor", icon = "spell_holy_heal", row = 5, col = 2, max = 1, req = "Illumination",
                  ranks = {
                ...
                { name = "Purifying Power", icon = "spell_holy_purifyingpower", row = 6, col = 1, max = 2,
                  ranks = {
        ...
        },
        {
            ...
            talents = {
                ...
                { name = "Blessing of Kings", icon = "spell_magic_magearmor", row = 3, col = 1, max = 1,
                  ranks = {
                ...
                { name = "Shield Specialization", icon = "inv_shield_06", row = 3, col = 3, max = 3, req = "Redoubt",
                  ranks = {
                ...
                { name = "Blessing of Sanctuary", icon = "spell_nature_lightningshield", row = 5, col = 2, max = 1,
                  ranks = {
                ...
                { name = "Reckoning", icon = "spell_holy_blessingofstrength", row = 5, col = 3, max = 5,
                  ranks = {
                ...
                { name = "Sacred Duty", icon = "spell_holy_divineintervention", row = 6, col = 1, max = 2,
                  ranks = {
                ...
                { name = "Improved Holy Shield", icon = "spell_holy_blessingofprotection", row = 7, col = 1, max = 2, req = "Holy Shield",
                  ranks = {
                ...
                { name = "Holy Shield", icon = "spell_holy_blessingofprotection", row = 7, col = 2, max = 1, req = "Blessing of Sanctuary",
                  ranks = {
                ...
                { name = "Ardent Defender", icon = "spell_holy_ardentdefender", row = 7, col = 3, max = 5,
                  ranks = {
                ...
                { name = "Avenger's Shield", icon = "spell_holy_avengersshield", row = 9, col = 2, max = 1, req = "Holy Shield",
                  ranks = {
        ...
        },
        {
            ...
            talents = {
                ...
                { name = "Seal of Command", icon = "ability_warrior_innerrage", row = 3, col = 3, max = 1,
                  ranks = {
                    "Fills the Paladin with the spirit of command, giving each melee attack a chance to deal additional Holy damage equal to 70% of normal weapon damage. Unleashing this Seal's energy will judge an enemy, instantly causing 68 to 73 Holy damage, 137 to 146 if the target is stunned or incapacitated. Lasts 30 sec.",
                  } },
                ...
                { name = "Sanctified Seals", icon = "spell_holy_holysmite", row = 7, col = 1, max = 3,
                  ranks = {
                ...
                { name = "Fanaticism", icon = "spell_holy_fanaticism", row = 8, col = 2, max = 5, req = "Repentance",
                  ranks = {
